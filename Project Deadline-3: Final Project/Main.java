...
public class Main extends Application implements Serializable {
    ...
    class game implements EventHandler<ActionEvent>, Serializable {
        ...
        public game(Stage stage, String s) {
            this.stage = stage;
            //img_path=s;
        ...
        public void handle(ActionEvent event) {
            ...
            head_p.setDuration(new Duration(120000));
            ...
            zombie2.setFitHeight(170);//set height of image
            zombie2.setFitWidth(170);
            ...
            Image img4 = new Image("file:C:\\Users\\SHANEY WARIS\\OneDrive\\Documents\\NetBeansProjects\\FX_Project\\src\\Plant_vs_Zombies\\images\\zombies animation\\zombie5.gif");

            zombie4.setImage(img4);
            zombie4.setFitHeight(190);//set height of image
            zombie4.setFitWidth(190);

            Image img5 = new Image("file:C:\\Users\\SHANEY WARIS\\OneDrive\\Documents\\NetBeansProjects\\FX_Project\\src\\Plant_vs_Zombies\\images\\zombies animation\\zombie3.gif");

            zombie5.setImage(img5);
            zombie5.setFitHeight(170);//set height of image
            zombie5.setFitWidth(170);
            ...
            // deserialize
            boolean exist = new File("C:\\Users\\SHANEY WARIS\\OneDrive\\Documents\\NetBeansProjects\\FX_Project\\src\\Plant_vs_Zombies\\hello.txt").exists();
            if (flag == 1 && exist == true) {
                ObjectInputStream in = null;
                try {
                    
                    in = new ObjectInputStream(new FileInputStream("C:\\Users\\SHANEY WARIS\\OneDrive\\Documents\\NetBeansProjects\\FX_Project\\src\\Plant_vs_Zombies\\hello.txt"));
            ...
            menu.setOnAction(e
                ...
                try {
                    user_out = new ObjectOutputStream(new FileOutputStream("C:\\Users\\SHANEY WARIS\\OneDrive\\Documents\\NetBeansProjects\\FX_Project\\src\\Plant_vs_Zombies\\hello.txt"));
    ...
    class load implements EventHandler<ActionEvent> {
        ...
        public void change_level(int x, int y) {
            ...
            b4.setOnAction(new game_level2(stage, "", flag));
            ...
            b5.setOnAction(new game_level3(stage, "", flag));
            ...
            b6.setOnAction(new game_level4(stage, "", flag));
            ...
            b7.setOnAction(new game_level5(stage, "", flag));
    ...
    class start implements EventHandler<ActionEvent> {
        ...
        public void handle(ActionEvent event) {
            ...
            player1 = new TextField("textfield");//textfield
            ...
            submit.setOnAction(e -> {
                users_names.add(player1.getText());
    ...
    class options implements EventHandler<ActionEvent> {
        ...
        public void handle(ActionEvent event) {
            ...
            Image img = new Image("file:C:\\Users\\SHANEY WARIS\\OneDrive\\Documents\\NetBeansProjects\\FX_Project\\src\\Plant_vs_Zombies\\images\\option_2.png");
            ...
            Image playI4 = null;
            if (state == 1) {
                playI4 = new Image("file:C:\\Users\\SHANEY WARIS\\OneDrive\\Documents\\NetBeansProjects\\FX_Project\\src\\Plant_vs_Zombies\\images\\1111.png");
                mediaPlayer.play();
            } else {
                playI4 = new Image("file:C:\\Users\\SHANEY WARIS\\OneDrive\\Documents\\NetBeansProjects\\FX_Project\\src\\Plant_vs_Zombies\\images\\2222.png");
                mediaPlayer.pause();
            }
    ...
    public static void main(String args[]) throws IOException, FileNotFoundException, ClassNotFoundException {
        boolean exist1 = new File("C:\\Users\\SHANEY WARIS\\OneDrive\\Documents\\NetBeansProjects\\FX_Project\\src\\Plant_vs_Zombies\\users_list.txt").exists();
        if (exist1) {
            deserialize();
        }
        ...
        Main m = new Main();
        Main.game ggg = m.new game();
        TimerTask task = ggg.new game1();
