...
class game_level5 implements EventHandler<ActionEvent> {
    ...
    class won implements EventHandler<ActionEvent>{
        ...
        public game_level5(Stage stage, String s, int flag) {
            this.stage = stage;
            this.flag = flag;
            //img_path=s;
        ...
        public void handle(ActionEvent event) {
            ...
            head_p.setDuration(new Duration(360000));
            ...
            // deserialize
            boolean exist = new File("C:\\Users\\SHANEY WARIS\\OneDrive\\Documents\\NetBeansProjects\\FX_Project\\src\\Plant_vs_Zombies\\level5_serialize.txt").exists();
            if (flag == 1 && exist == true) {
                ObjectInputStream in = null;
                try {
                    in = new ObjectInputStream(new FileInputStream("C:\\Users\\SHANEY WARIS\\OneDrive\\Documents\\NetBeansProjects\\FX_Project\\src\\Plant_vs_Zombies\\level5_serialize.txt"));
            ...
            menu.setOnAction(e
                ...
                try {
                    user_out = new ObjectOutputStream(new FileOutputStream("C:\\Users\\SHANEY WARIS\\OneDrive\\Documents\\NetBeansProjects\\FX_Project\\src\\Plant_vs_Zombies\\level5_serialize.txt"));
